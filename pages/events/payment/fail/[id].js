  ...
  return (
    <div id='payment-success-container'>
      <div id='payment-success'>
        ...
        <div id='event-image-fail'>
          <Image src='/test.jpg' alt='event' width={200} height={200} />
          <span id='payment-fail-image-item'>
            <i className='pi pi-info p-icon-large' />
          </span>
        </div>
      </div>
    </div>
